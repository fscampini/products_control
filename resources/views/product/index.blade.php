        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <a href="{{ Route('admin.product.create') }}" class="btn btn-primary" role="button">Adicionar Produto</a>
                    <br>
                    <br>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="{{ Route('admin.product.edit', $product->id) }}">Editar</a></li>
                                            <li><a onclick="show_modal('{{ Route('admin.product.destroy', $product->id) }}', '{{ $product->name }}')" data-toggle="modal" data-target="#myModal" href="#">Excluir</a></li>
